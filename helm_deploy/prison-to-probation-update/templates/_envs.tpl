...
env:
  ...
  - name: PRISONTOPROBATION_MESSAGE_PROCESSOR_DELAY
    value: "{{ .Values.env.PRISONTOPROBATION_MESSAGE_PROCESSOR_DELAY }}"

  - name: PRISONTOPROBATION_HOLD_BACK_DURATION
    value: "{{ .Values.env.PRISONTOPROBATION_HOLD_BACK_DURATION }}"

...
fun TelemetryEvent.with(booking: Booking): TelemetryEvent = TelemetryEvent(this.name, this.attributes +
    with(booking) {
      mapOf(
...
fun TelemetryEvent.with(sentenceDetail: SentenceDetail): TelemetryEvent = TelemetryEvent(this.name, this.attributes +
    with(sentenceDetail) {
      mapOf("sentenceStartDate" to sentenceStartDate.asTelemetry(),

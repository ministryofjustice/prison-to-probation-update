...
fun HmppsSnsProperties.prisonEventTopic() = topics["prisonEventTopic"] ?: throw MissingTopicException("prisonEventTopic has not been loaded from configuration properties")
fun HmppsSnsProperties.hmppsEventTopic() = topics["hmppsEventTopic"] ?: throw MissingTopicException("hmppsEventTopic has not been loaded from configuration properties")
